...
object CriticalsJump : Choice("Jump") {
    ...
    fun shouldWaitForCrit(target: Entity, ignoreState: Boolean = false): Boolean {
        ...
        ModuleDebugRecorder.GenericDebugRecorder.recordDebugInfo(ModuleCriticals, "critEstimation", JsonObject().apply {
            ...
            add("player", ModuleDebugRecorder.GenericDebugRecorder.debugObject(player))
            add("target", ModuleDebugRecorder.GenericDebugRecorder.debugObject(target))
            addProperty("simulatedPlayerPos", simulatedPlayerPos.toString())
            addProperty("simulatedTargetPos", simulatedTargetPos.toString())
        })

        ModuleDebugRecorder.GenericDebugRecorder.debugEntityIn(target, ticksTillCrit.toInt())
