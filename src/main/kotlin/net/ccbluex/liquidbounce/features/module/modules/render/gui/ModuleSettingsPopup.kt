...
class ModuleSettingsPopup(
    ...
    fun mouseClicked(mouseX: Double, mouseY: Double, button: Int): Boolean {
        ...
        // Check if click is outside any widget but inside popup
        val localMouseY = mouseY + scrollOffset
        val isClickOnWidget = settingWidgets.any { it.isMouseOver(mouseX.toInt(), localMouseY.toInt()) }
        if (!isClickOnWidget) {
            // If click is inside popup but not on any widget, clean up active states
            cleanupActiveStates()
        }
