...
object ModuleDebugRecorder : ClientModule("DebugRecorder", Category.MISC, disableOnQuit = true) {
    ...
    abstract class DebugRecorderMode<T>(name: String) : Choice(name) {
        ...
        fun recordDebugInfo(
            @Suppress("UNUSED_PARAMETER") module: ClientModule,
            @Suppress("UNUSED_PARAMETER") infoType: String,
            @Suppress("UNUSED_PARAMETER") data: JsonObject
        ) {
            // Placeholder implementation if actual debug recording is needed
        }

        fun debugObject(@Suppress("UNUSED_PARAMETER") obj: Any): JsonObject {
            // Placeholder implementation
            return JsonObject()
        }

        fun debugEntityIn(@Suppress("UNUSED_PARAMETER") target: Entity, @Suppress("UNUSED_PARAMETER") ticks: Int) {
            // Placeholder implementation
        }
    }

    object GenericDebugRecorder : DebugRecorderMode<Any>("Generic")
    object DebugCPSRecorder : DebugRecorderMode<Any>("CPS")
    object AimDebugRecorder : DebugRecorderMode<Any>("Aim")
    object BoxDebugRecorder : DebugRecorderMode<Any>("Box")
}
